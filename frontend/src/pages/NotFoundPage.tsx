...
export default function NotFoundPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-page">
      <SeoHead title={t("notFound.title")} description="" noIndex />
      <h1 className="text-6xl font-bold text-white/20">{t("notFound.title")}</h1>
      <p className="mt-4 text-lg text-white/45">{t("notFound.message")}</p>
      <Link
        to="/dashboard"
