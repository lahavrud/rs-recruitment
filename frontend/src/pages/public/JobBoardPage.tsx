...
import FilterChip from "./components/JobBoardFilterChip";
import { FilterSidebarSkeleton, SearchBarSkeleton } from "./components/JobBoardSkeletons";
import FilterPanel, {
  type SalaryBounds,
  type FilterPanelProps,
} from "./components/JobBoardFilterPanel";
import { SALARY_STEP, formatSalaryShort } from "./components/jobBoardUtils";
...
export default function JobBoardPage() {
  ...
  const baseFilterPanelProps: Omit<FilterPanelProps, "showSearch"> = {
    query,
