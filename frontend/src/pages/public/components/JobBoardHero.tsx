...
function ruleDraw(delay = "0s"): CSSProperties {
  return {
    animation: `line-expand-h 0.7s cubic-bezier(0.22, 1, 0.36, 1) ${delay} both`,
  ...
  return (
    <section className="relative overflow-hidden bg-void pt-28 pb-14 sm:pt-32 sm:pb-16">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "image-set(url('/property-exterior.webp') type('image/webp'), url('/property-exterior.jpg') type('image/jpeg'))",
